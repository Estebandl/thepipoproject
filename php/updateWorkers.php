...
<body>
                ...
                <input type="text" name="primerCognom" placeholder="" value="<?php echo $primerCognom ?>">
                <br><br>
                
                <label for="segonCognom">2on Cognom</label><br>
                <input type="text" name="segonCognom" placeholder="" value="<?php echo $segonCognom ?>">
                <br><br>
                
                <label for="dni">DNI</label><br>
                <input type="text" name="dni" placeholder="" value="<?php echo $dni ?>">
                <br><br>
                
                <label for="dataNaixament">Data de naixement (DD/MM/AAAA)</label><br>
                <input type="text" name="dataNaixament" placeholder="" value="<?php echo $dataNaixament ?>">
                <br><br>
                
                <label for="sexe">Sexe</label><br>
                <input type="radio" name="sexe" placeholder="1">Home
                <input type="radio" name="sexe" placeholder="0">Dona
                <br><br>
                
                <label for="nacionalitat">Nacionalitat</label><br>
                <input type="text" name="nacionalitat" placeholder="" value="<?php echo $nacionalitat ?>">
                <br><br>
